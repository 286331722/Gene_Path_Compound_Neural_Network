...
def plot_compaison(ax1, label, df_pnet, df_dense):
    ...
    ax1.legend(['GPC', 'Dense'], fontsize=8, loc='upper left')
    #ax1.legend(['GPC', 'GPC-single'], fontsize=8, loc='upper left')
...
def plot_(df_pnet, df_dense):
    ...
    #ax1.legend(['GPC', 'Dense'], fontsize=10)
    ax1.legend(['GPC', 'Dense'], fontsize=10, loc='upper left')
